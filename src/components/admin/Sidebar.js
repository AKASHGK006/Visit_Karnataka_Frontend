          ...
          <nav className="mt-4">
            <ul>
              <li className="px-4 py-2 hover:bg-gray-800">
                <Link to="/admin" className="block items-center justify-between" onClick={closeOtherMenus}>
              ...
              <li className="px-4 py-2 hover:bg-gray-800">
                <Link to="/admin/places" className="items-center flex justify-between" onClick={closeOtherMenus}>
              ...
              <li className="px-4 py-2 hover:bg-gray-800">
                <Link to="/admin/feedback" className=" items-center flex justify-between" onClick={closeOtherMenus}>
