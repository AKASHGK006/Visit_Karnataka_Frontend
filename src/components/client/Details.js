...
const Details = () => {
  ...
  const fetchPlaceDetails = async (placeId) => {
    try {
      const response = await fetch(`${baseUrl}/places/${placeId}`); // Adjust URL accordingly
      if (response.ok) {
      ...
      <div className="container mx-auto px-4 pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="col-span-1 md:col-span-1">
            <img className="w-full rounded" src={`${baseUrl}/${place.image}`} alt="" />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="mt-0">{place.policestation}</p>
            </div>
            ...
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="mt-0">{place.firestation}</p>
              <div className="col-span-1 md:col-span-1">
                <h3 className="my-5 text-xl font-bold flex items-center">
                ...
                <p className="mt-0">Name - {place.guidename} </p>
                <p className="mt-0">Mobile - {place.guidemobile} </p>
                <p className="mt-0">Language - {place.guidelanguage} </p>
              </div>
              <div className="flex">
